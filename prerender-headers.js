...
exports.handler = (event, context, callback) => {
    ...
    if (user_agent && host) {
      ...
      if (prerender) {
        headers['x-prerender-token'] = [{ key: 'X-Prerender-Token', value: 'pxmD4Aq1SOp4NmLCuvcA'}];
    ...
    console.log(`Outgoing request: ${JSON.stringify(request)}`);
